...
# Logging configuration for Production (LiteSpeed / Passenger stderr logging)
LOGGING = {
    'version': 1,
...
EMAIL_HOST = env('EMAIL_HOST', default='mail.helplinehellonaogaon.com')
EMAIL_PORT = env.int('EMAIL_PORT', default=465)
EMAIL_USE_SSL = env.bool('EMAIL_USE_SSL', default=True)
EMAIL_USE_TLS = env.bool('EMAIL_USE_TLS', default=False)
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='info@helplinehellonaogaon.com')
